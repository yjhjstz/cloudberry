...
-- ===================================================================
-- start_ignore
drop database if exists parallel_retrieve_db;
create database parallel_retrieve_db;
\c parallel_retrieve_db
...
CREATE SERVER loopback FOREIGN DATA WRAPPER cloudberry_fdw
