...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_type_test_1', 'paa_cluster', 'hive_text_type_test_1', 'hive_server');
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_type_test_2', 'paa_cluster', 'hive_text_type_test_2', 'hive_server');
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_type_test_3', 'paa_cluster', 'hive_text_type_test_3', 'hive_server');
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_type_test_4', 'paa_cluster', 'hive_text_type_test_4', 'hive_server');
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_type_test_5', 'paa_cluster', 'hive_text_type_test_5', 'hive_server');
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_type_test_6', 'paa_cluster', 'hive_text_type_test_6', 'hive_server');
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_type_test_7', 'paa_cluster', 'hive_text_type_test_7', 'hive_server');
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_type_test_8', 'paa_cluster', 'hive_text_type_test_8', 'hive_server');
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_type_test_9', 'paa_cluster', 'hive_text_type_test_9', 'hive_server');
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_type_test_10', 'paa_cluster', 'hive_text_type_test_10', 'hive_server');
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_test_1', 'paa_cluster', 'hive_text_test_1', 'hive_server');
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_test_2', 'paa_cluster', 'hive_text_test_2', 'hive_server');
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_test_3', 'paa_cluster', 'hive_text_test_3', 'hive_server');
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_test_4', 'paa_cluster', 'hive_text_test_4', 'hive_server');
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_test_5', 'paa_cluster', 'hive_text_test_5', 'hive_server');
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_test_6', 'paa_cluster', 'hive_text_test_6', 'hive_server');
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_test_7', 'paa_cluster', 'hive_text_test_7', 'hive_server');
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_test_8', 'paa_cluster', 'hive_text_test_8', 'hive_server');
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_test_11', 'paa_cluster', 'hive_text_test_11', 'hive_server');
select * from hive_text_test_11;
select count(*) from hive_text_test_11;

DROP FOREIGN TABLE IF EXISTS hive_text_test_12;
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_test_12', 'paa_cluster', 'hive_text_test_12', 'hive_server');
select * from hive_text_test_12;
select count(*) from hive_text_test_12;

DROP FOREIGN TABLE IF EXISTS hive_text_test_13;
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_test_13', 'paa_cluster', 'hive_text_test_13', 'hive_server');
