...
select sync_hive_table('hive_cluster', 'hive_orc_load_data_test', 'hive_type_test_1', 'paa_cluster', 'hive_type_test_1', 'hive_server');
...
select sync_hive_table('hive_cluster', 'hive_orc_load_data_test', 'hive_type_test_2', 'paa_cluster', 'hive_type_test_2', 'hive_server');
...
select sync_hive_table('hive_cluster', 'hive_orc_load_data_test', 'hive_type_test_3', 'paa_cluster', 'hive_type_test_3', 'hive_server');
...
select sync_hive_table('hive_cluster', 'hive_orc_load_data_test', 'hive_type_test_4', 'paa_cluster', 'hive_type_test_4', 'hive_server');
...
select sync_hive_table('hive_cluster', 'hive_orc_load_data_test', 'hive_type_test_5', 'paa_cluster', 'hive_type_test_5', 'hive_server');
...
select sync_hive_table('hive_cluster', 'hive_orc_load_data_test', 'hive_type_test_6', 'paa_cluster', 'hive_type_test_6', 'hive_server');
...
select sync_hive_table('hive_cluster', 'hive_orc_load_data_test', 'hive_type_test_7', 'paa_cluster', 'hive_type_test_7', 'hive_server');
...
select sync_hive_table('hive_cluster', 'hive_orc_load_data_test', 'hive_type_test_8', 'paa_cluster', 'hive_type_test_8', 'hive_server');
...
select sync_hive_table('hive_cluster', 'hive_orc_load_data_test', 'hive_type_test_9', 'paa_cluster', 'hive_type_test_9', 'hive_server');
...
select sync_hive_table('hive_cluster', 'hive_orc_load_data_test', 'hive_type_test_10', 'paa_cluster', 'hive_type_test_10', 'hive_server');
...
select sync_hive_table('hive_cluster', 'hive_orc_load_data_test', 'hive_test_1', 'paa_cluster', 'hive_test_1', 'hive_server');
...
select sync_hive_table('hive_cluster', 'hive_orc_load_data_test', 'hive_test_2', 'paa_cluster', 'hive_test_2', 'hive_server');
...
select sync_hive_table('hive_cluster', 'hive_orc_load_data_test', 'hive_test_3', 'paa_cluster', 'hive_test_3', 'hive_server');
...
select sync_hive_table('hive_cluster', 'hive_orc_load_data_test', 'hive_test_4', 'paa_cluster', 'hive_test_4', 'hive_server');
...
select sync_hive_table('hive_cluster', 'hive_orc_load_data_test', 'hive_test_5', 'paa_cluster', 'hive_test_5', 'hive_server');
...
select sync_hive_table('hive_cluster', 'hive_orc_load_data_test', 'hive_test_6', 'paa_cluster', 'hive_test_6', 'hive_server');
...
select sync_hive_table('hive_cluster', 'hive_orc_load_data_test', 'hive_test_7', 'paa_cluster', 'hive_test_7', 'hive_server');
select * from hive_test_7 order by id, name, m, n, o, p;
select count(*) from hive_test_7;

-- hive partiton key is int and string and decimal and tinyint type
DROP FOREIGN TABLE IF EXISTS hive_test_8;
select sync_hive_table('hive_cluster', 'hive_orc_load_data_test', 'hive_test_8', 'paa_cluster', 'hive_test_8', 'hive_server');
...
DROP FOREIGN TABLE IF EXISTS hive_test_9;
select sync_hive_table('hive_cluster', 'hive_orc_load_data_test', 'hive_test_9', 'paa_cluster', 'hive_test_9', 'hive_server');
select * from hive_test_9 order by id, name, m, n, more1, more2;
select count(*) from hive_test_9;
select count(more1) from hive_test_9;
select more1 from hive_test_9 order by more1;
select more2, more1 from hive_test_9 order by more2, more1;
