...
CREATE READABLE EXTERNAL TABLE read_one_file(a int, b text) LOCATION('gphdfs://ci-test-data/text/onefile hdfs_cluster_name=paa_cluster') FORMAT 'text';
select * from read_one_file order by a;
DROP EXTERNAL TABLE IF EXISTS read_one_file;

DROP EXTERNAL TABLE IF EXISTS read_one_file2;
CREATE READABLE EXTERNAL TABLE read_one_file2(a int, b text) LOCATION('gphdfs://ci-test-data/text/onefile/ hdfs_cluster_name=paa_cluster') FORMAT 'text';
select * from read_one_file2 order by a;
DROP EXTERNAL TABLE IF EXISTS read_one_file2;

DROP EXTERNAL TABLE IF EXISTS read_two_file;
CREATE READABLE EXTERNAL TABLE read_two_file(a int, b text) LOCATION('gphdfs://ci-test-data/text/twofile hdfs_cluster_name=paa_cluster') FORMAT 'text';
select * from read_two_file order by a;
DROP EXTERNAL TABLE IF EXISTS read_two_file;

DROP EXTERNAL TABLE IF EXISTS read_more_file;
CREATE READABLE EXTERNAL TABLE read_more_file(a int, b text) LOCATION('gphdfs://ci-test-data/text/more_file hdfs_cluster_name=paa_cluster') FORMAT 'text';
select * from read_more_file order by a;
DROP EXTERNAL TABLE IF EXISTS read_more_file;

DROP EXTERNAL TABLE IF EXISTS read_more_file2;
CREATE READABLE EXTERNAL TABLE read_more_file2(a int, b text) LOCATION('gphdfs://ci-test-data/text/more_file2 hdfs_cluster_name=paa_cluster') FORMAT 'text';
select * from read_more_file2 order by a;
DROP EXTERNAL TABLE IF EXISTS read_more_file2;

DROP EXTERNAL TABLE IF EXISTS read_invalid_file_path;
CREATE READABLE EXTERNAL TABLE read_invalid_file_path(a int, b text) LOCATION('gphdfs://ci-test-data/text/invalid_path hdfs_cluster_name=paa_cluster') FORMAT 'text';
select * from read_invalid_file_path order by a;
DROP EXTERNAL TABLE IF EXISTS read_invalid_file_path;

DROP EXTERNAL TABLE IF EXISTS read_empty_file_path;
CREATE READABLE EXTERNAL TABLE read_empty_file_path(a int, b text) LOCATION('gphdfs://ci-test-data/text/empty_path hdfs_cluster_name=paa_cluster') FORMAT 'text';
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_type_test_1', 'paa_cluster', 'hive_type_test_1');
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_type_test_2', 'paa_cluster', 'hive_type_test_2');
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_type_test_3', 'paa_cluster', 'hive_type_test_3');
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_type_test_4', 'paa_cluster', 'hive_type_test_4');
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_type_test_5', 'paa_cluster', 'hive_type_test_5');
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_type_test_6', 'paa_cluster', 'hive_type_test_6');
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_type_test_7', 'paa_cluster', 'hive_type_test_7');
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_type_test_8', 'paa_cluster', 'hive_type_test_8');
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_type_test_9', 'paa_cluster', 'hive_type_test_9');
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_type_test_10', 'paa_cluster', 'hive_type_test_10');
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_test_1', 'paa_cluster', 'hive_test_1');
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_test_2', 'paa_cluster', 'hive_test_2');
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_test_3', 'paa_cluster', 'hive_test_3');
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_test_4', 'paa_cluster', 'hive_test_4');
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_test_5', 'paa_cluster', 'hive_test_5');
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_test_6', 'paa_cluster', 'hive_test_6');
...
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_test_7', 'paa_cluster', 'hive_test_7');
select * from hive_test_7 order by id, name, m, n, o, p;
select count(*) from hive_test_7;

-- hive partiton key is int and string and decimal and tinyint type
DROP EXTERNAL TABLE IF EXISTS hive_test_8;
select sync_hive_table('hive_cluster', 'hive_text_load_data_test', 'hive_test_8', 'paa_cluster', 'hive_test_8');
