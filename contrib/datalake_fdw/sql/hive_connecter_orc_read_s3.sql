...
select sync_hive_table_s3('hive_s3_cluster', 'hive_orc_load_data_test', 'hive_type_test_1', 'hive_type_test_1', 'hive_s3_server');
...
select sync_hive_table_s3('hive_s3_cluster', 'hive_orc_load_data_test', 'hive_type_test_2', 'hive_type_test_2', 'hive_s3_server');
...
select sync_hive_table_s3('hive_s3_cluster', 'hive_orc_load_data_test', 'hive_type_test_3', 'hive_type_test_3', 'hive_s3_server');
...
select sync_hive_table_s3('hive_s3_cluster', 'hive_orc_load_data_test', 'hive_type_test_4', 'hive_type_test_4', 'hive_s3_server');
...
select sync_hive_table_s3('hive_s3_cluster', 'hive_orc_load_data_test', 'hive_type_test_5', 'hive_type_test_5', 'hive_s3_server');
...
select sync_hive_table_s3('hive_s3_cluster', 'hive_orc_load_data_test', 'hive_type_test_6', 'hive_type_test_6', 'hive_s3_server');
...
select sync_hive_table_s3('hive_s3_cluster', 'hive_orc_load_data_test', 'hive_type_test_7', 'hive_type_test_7', 'hive_s3_server');
...
select sync_hive_table_s3('hive_s3_cluster', 'hive_orc_load_data_test', 'hive_type_test_8', 'hive_type_test_8', 'hive_s3_server');
...
select sync_hive_table_s3('hive_s3_cluster', 'hive_orc_load_data_test', 'hive_type_test_9', 'hive_type_test_9', 'hive_s3_server');
...
select sync_hive_table_s3('hive_s3_cluster', 'hive_orc_load_data_test', 'hive_type_test_10', 'hive_type_test_10', 'hive_s3_server');
...
select sync_hive_table_s3('hive_s3_cluster', 'hive_orc_load_data_test', 'hive_test_1', 'hive_test_1', 'hive_s3_server');
...
select sync_hive_table_s3('hive_s3_cluster', 'hive_orc_load_data_test', 'hive_test_2', 'hive_test_2', 'hive_s3_server');
...
select sync_hive_table_s3('hive_s3_cluster', 'hive_orc_load_data_test', 'hive_test_3', 'hive_test_3', 'hive_s3_server');
...
select sync_hive_table_s3('hive_s3_cluster', 'hive_orc_load_data_test', 'hive_test_4', 'hive_test_4', 'hive_s3_server');
...
select sync_hive_table_s3('hive_s3_cluster', 'hive_orc_load_data_test', 'hive_test_5', 'hive_test_5', 'hive_s3_server');
...
select sync_hive_table_s3('hive_s3_cluster', 'hive_orc_load_data_test', 'hive_test_6', 'hive_test_6', 'hive_s3_server');
...
select sync_hive_table_s3('hive_s3_cluster', 'hive_orc_load_data_test', 'hive_test_7', 'hive_test_7', 'hive_s3_server');
select * from hive_test_7 order by id, name, m, n, o, p;
select count(*) from hive_test_7;

-- hive partiton key is int and string and decimal and tinyint type
DROP FOREIGN TABLE IF EXISTS hive_test_8;
select sync_hive_table_s3('hive_s3_cluster', 'hive_orc_load_data_test', 'hive_test_8', 'hive_test_8', 'hive_s3_server');
...
select sync_hive_table_s3('hive_s3_cluster', 'hive_orc_load_data_test', 'hive_test_9', 'hive_test_9', 'hive_s3_server');
