CREATE DATABASE IF NOT EXISTS hive_deflate_text_load_data_test;

USE hive_deflate_text_load_data_test;
...
STORED AS TEXTFILE
TBLPROPERTIES ('compression.type'='deflate');
...
partitioned by (name3 string) CLUSTERED BY (id) INTO 5 BUCKETS STORED AS TEXTFILE
TBLPROPERTIES ("transactional"="false",
...
ALTER TABLE hive_test_3 ADD PARTITION (m=4);
...
drop table if exists hive_test_10;
...
STORED AS TEXTFILE
TBLPROPERTIES ('compression.type'='deflate');
INSERT INTO TABLE hive_test_10 PARTITION(m=1) values(10, "aaaaabbbb");
INSERT INTO TABLE hive_test_10 PARTITION(m=1) values(9, "bbbbcccc");
INSERT INTO TABLE hive_test_10 PARTITION(m=1) values(8, "ddddbbbb");
INSERT INTO TABLE hive_test_10 PARTITION(m=1) values(7, "fdsfsf");
INSERT INTO TABLE hive_test_10 PARTITION(m=1) values(6, "rewrwr3r2");
INSERT INTO TABLE hive_test_10 PARTITION(m=2) values(1, "fsdf");
INSERT INTO TABLE hive_test_10 PARTITION(m=2) values(2, "rewrwe");
INSERT INTO TABLE hive_test_10 PARTITION(m=2) values(3, "2345fsd");
INSERT INTO TABLE hive_test_10 PARTITION(m=2) values(4, "trewtaf");
INSERT INTO TABLE hive_test_10 PARTITION(m=2) values(5, "fdsfsdfwe");
INSERT INTO TABLE hive_test_10 PARTITION(m=3) values(1, "23423");
INSERT INTO TABLE hive_test_10 PARTITION(m=3) values(2, "werwer");
INSERT INTO TABLE hive_test_10 PARTITION(m=3) values(3, "2345gagefsd");
INSERT INTO TABLE hive_test_10 PARTITION(m=3) values(4, "46346");
INSERT INTO TABLE hive_test_10 PARTITION(m=3) values(5, "agasdg");
ALTER TABLE hive_test_10 ADD PARTITION (m=4);
INSERT INTO TABLE hive_test_10 PARTITION(m=5) values(5, "agasdg");
INSERT INTO TABLE hive_test_10 PARTITION(m=5) values(5, "agasdg");
INSERT INTO TABLE hive_test_10 PARTITION(m=5) values(5, "agasdg");
ALTER TABLE hive_test_10 ADD PARTITION (m=6);
ALTER TABLE hive_test_10 ADD PARTITION (m=7);
ALTER TABLE hive_test_10 ADD PARTITION (m=13);
INSERT INTO TABLE hive_test_10 PARTITION(m=8) values(5, "agasdg");
INSERT INTO TABLE hive_test_10 PARTITION(m=8) values(5, "agasdg");
INSERT INTO TABLE hive_test_10 PARTITION(m=8) values(5, "agasdg");
ALTER TABLE hive_test_10 ADD PARTITION (m=9);
ALTER TABLE hive_test_10 ADD COLUMNS (more1 int, more2 string);
INSERT INTO TABLE hive_test_10 PARTITION(m=10) values(5, "agasdg", 6, "bbb");
INSERT INTO TABLE hive_test_10 PARTITION(m=10) values(5, "agasdg", 6, "bbb");
INSERT INTO TABLE hive_test_10 PARTITION(m=10) values(5, "agasdg", 6, "bbb");
ALTER TABLE hive_test_10 ADD PARTITION (m=11);
ALTER TABLE hive_test_10 ADD COLUMNS (more3 int, more4 string);

drop table if exists hive_test_11;
CREATE TABLE hive_test_11
(
    id  int,
    name string
)
...
drop table if exists hive_test_12;
CREATE TABLE hive_test_12
(
    id  int,
    name string
)
...
STORED AS TEXTFILE;
ALTER TABLE hive_test_12 ADD PARTITION (m=1);
ALTER TABLE hive_test_12 ADD PARTITION (m=2);
ALTER TABLE hive_test_12 ADD PARTITION (m=3);
ALTER TABLE hive_test_12 ADD PARTITION (m=4);

drop table if exists hive_test_13;
CREATE TABLE hive_test_13
(
    id  int,
    name string
)
