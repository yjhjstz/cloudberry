...
public class DlIcebergHiveCatalog extends BaseMetastoreCatalog implements SupportsNamespaces, Configurable {
    public static final String LIST_ALL_TABLES = "list-all-tables";
    public static final String LIST_ALL_TABLES_DEFAULT = "false";

    private static final Logger LOG = LoggerFactory.getLogger(DlIcebergHiveCatalog.class);
    ...
    public DlIcebergHiveCatalog(SecureLogin secureLogin, String serverName, String configFile) {
    ...
    public void initialize(String inputName, Map<String, String> properties) {
        ...
        this.clients = new DlCachedClientPool(conf, properties, secureLogin, serverName, configFile);
    }
