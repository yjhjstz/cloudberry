...
public class ApiaryDropPartitionEvent extends ApiaryListenerEvent {
  ...
  ApiaryDropPartitionEvent() {}

  public ApiaryDropPartitionEvent(DropPartitionEvent event) {
    super(event);
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof ApiaryDropPartitionEvent)) {
      return false;
    }
    ApiaryDropPartitionEvent other = (ApiaryDropPartitionEvent) obj;
