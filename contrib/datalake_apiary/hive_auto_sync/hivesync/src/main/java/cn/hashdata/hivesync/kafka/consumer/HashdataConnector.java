...
public class HashdataConnector {
    private static final Logger log = LoggerFactory.getLogger(HashdataConnector.class);
    ...
    private void initDatasource() {
        try (Connection conn = ds.getConnection()) {
            ...
            log.error("Init hashdata datasource failed!", e);
        }
    }

    public HashdataConnector(Properties props) throws SQLException {
        ...
        log.debug("Build hashdataConnector: " + hdwUser + ":" + hdwPasswd + "@" + hdwHost + ":" + hdwPort + "/" + hdwDatabase + " with " + hdwSecretKey);
        buildDataSource();
        initDatasource();
    }
