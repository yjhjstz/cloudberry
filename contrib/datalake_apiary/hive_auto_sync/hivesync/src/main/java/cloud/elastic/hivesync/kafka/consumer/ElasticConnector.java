...
public class ElasticConnector {
    ...
    private void initDatasource() {
        try (Connection conn = ds.getConnection()) {
            ...
            log.error("Init elastic datasource failed!", e);
        }
    }

    public ElasticConnector(Properties props) throws SQLException {
        ...
        log.debug("Build ElasticConnector: " + hdwUser + ":" + hdwPasswd + "@" + hdwHost + ":" + hdwPort + "/" + hdwDatabase + " with " + hdwSecretKey);
        buildDataSource();
        initDatasource();
    }
