...
import cloud.elastic.hivesync.kafka.prometheus.PrometheusHTTPServer;
...
import static cloud.elastic.hivesync.kafka.consumer.HiveAutoSyncProperty.HDW_CATNAME;
import static cloud.elastic.hivesync.kafka.consumer.HiveAutoSyncProperty.HDW_DB;
import static cloud.elastic.hivesync.kafka.consumer.HiveAutoSyncProperty.HDW_HOST;
import static cloud.elastic.hivesync.kafka.consumer.HiveAutoSyncProperty.HDW_PORT;
import static cloud.elastic.hivesync.kafka.consumer.HiveAutoSyncProperty.HDW_SECRET;
import static cloud.elastic.hivesync.kafka.consumer.HiveAutoSyncProperty.HDW_USER;
import static cloud.elastic.hivesync.kafka.consumer.HiveAutoSyncProperty.HIVE_CATLIST;
import static cloud.elastic.hivesync.kafka.consumer.HiveAutoSyncProperty.HIVE_CATNAME;
import static cloud.elastic.hivesync.kafka.consumer.HiveAutoSyncProperty.HIVE_CLUSTERS;
import static cloud.elastic.hivesync.kafka.consumer.HiveAutoSyncProperty.HIVE_CLUSTER_NAME;
import static cloud.elastic.hivesync.kafka.consumer.HiveAutoSyncProperty.HIVE_GPNAME;
import static cloud.elastic.hivesync.kafka.consumer.HiveAutoSyncProperty.HIVE_HDFSNAME;
...
import static cloud.elastic.hivesync.kafka.consumer.HiveAutoSyncProperty.PROMETHEUS_PORT;
import static cloud.elastic.hivesync.kafka.consumer.HiveAutoSyncProperty.TOPIC_NAME;
import static cloud.elastic.hivesync.kafka.consumer.HiveAutoSyncProperty.HDW_PASSWD;
