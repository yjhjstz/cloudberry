...
-- The index chosen for tenk2 (tenk2_unique2 or tenk2_hundred) is non-deterministic
-- since width=0 means any index works equally well.
--
-- start_matchignore
-- m/Index Only Scan using tenk2_\w+ on tenk2/
-- end_matchignore
