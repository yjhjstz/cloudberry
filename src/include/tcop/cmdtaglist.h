...
PG_CMDTAG(CMDTAG_CREATE_FOREIGN_VOLUME, "CREATE FOREIGN VOLUME", true, false, false)
...
PG_CMDTAG(CMDTAG_CREATE_LAKE_TABLE, "CREATE LAKE TABLE", true, false, false)
...
PG_CMDTAG(CMDTAG_CREATE_FOREIGN_CATALOG, "CREATE FOREIGN CATALOG", true, false, false)
...
PG_CMDTAG(CMDTAG_DROP_FOREIGN_CATALOG, "DROP FOREIGN CATALOG", true, false, false)
PG_CMDTAG(CMDTAG_DROP_FOREIGN_TABLE, "DROP FOREIGN TABLE", true, false, false)
PG_CMDTAG(CMDTAG_DROP_FOREIGN_VOLUME, "DROP FOREIGN VOLUME", true, false, false)
