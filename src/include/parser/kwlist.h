...
PG_KEYWORD("hudi", HUDI, UNRESERVED_KEYWORD, BARE_LABEL)             /* GPDB */
PG_KEYWORD("iceberg", ICEBERG, UNRESERVED_KEYWORD, BARE_LABEL)       /* GPDB */
...
PG_KEYWORD("volume", VOLUME, UNRESERVED_KEYWORD, BARE_LABEL)
