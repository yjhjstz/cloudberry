...
function cbdb_build() {
    ...
    CFLAGS=-O0 CXXFLAGS='-O0 -std=c++17' ./configure --prefix=${install_dir}/cbdb --enable-debug --enable-cassert --enable-tap-tests --with-gssapi --with-libxml --with-quicklz --with-pythonsrc-ext --with-openssl
